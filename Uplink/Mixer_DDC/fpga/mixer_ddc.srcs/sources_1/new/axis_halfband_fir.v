...
// Engineer: 
// 
// Create Date: 05/30/2026 07:24:07 PM
// Design Name: 
// Module Name: axis_halfband_fir
// Project Name: Van-Huynh Nguyen
...
module axis_halfband_fir #(parameter WIDTH=32)(
	input aclk,
	input aresetn,
	//SLAVE
	...
	//saturation 1.15
	assign nor_I = ((div_I[WIDTH-1]==0) & (div_I[WIDTH-2:15]!=0)) ? 32767 :  (((div_I[WIDTH-1]==1) & (div_I[WIDTH-2:15]!=16'hFFFF)) ? 32768:  div_I[WIDTH/2-1 : 0]) ;
	assign nor_Q = ((div_Q[WIDTH-1]==0) & (div_Q[WIDTH-2:15]!=0)) ? 32767 :  (((div_Q[WIDTH-1]==1) & (div_Q[WIDTH-2:15]!=16'hFFFF)) ? 32768:  div_Q[WIDTH/2-1 : 0]) ;
	//halfband_fir
	//h = [-1 0 9 16 9 0 -1] / 16
