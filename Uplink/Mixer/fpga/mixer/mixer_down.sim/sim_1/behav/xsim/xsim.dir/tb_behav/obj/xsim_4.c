...
void relocate(char *dp)
{
	...
	iki_vhdl_file_variable_register(dp + 419664);
	iki_vhdl_file_variable_register(dp + 419720);
...

{
	...
	iki_vlog_schedule_transaction_signal_fast_vhdl_value_time_0(dp + 519568, dp + 517016, 0, 79, 0, 79, 80, 1);
