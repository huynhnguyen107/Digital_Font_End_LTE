...
#include "lte20_ul_mixer_golden_q15.h"// for the golden output data slot 245760 bytes
...
int main(void) {
    ...
    for (size_t i = 0; i < LTE20_UL_MIXER_OUT_SAMPLES; i++) {
    ...
    DMA_REG(dma, DMA_S2MM_LENGTH_OFFSET) = LTE20_UL_MIXER_OUT_BYTES; // Set S2MM transfer length
    ...
    for (size_t i = 0; i < LTE20_UL_MIXER_OUT_SAMPLES; i++) {
        ...
        uint32_t golden_sample = lte20_ul_mixer_golden_q15[i];
