...
#include "lte20_duc_golden_q15_10.h"// for the input data slot 245760 bytes
#include "lte20_ddc_golden_q15_10.h"// for the golden output data slot 61440 bytes
...
int main(void) {
    ...
    if (LTE20_DUC_OUT_SAMPLES !=40) {
        printf("Error: Unexpected number of input samples. Expected 40, got %d\n", LTE20_DUC_OUT_SAMPLES);
        return -1;
    }
    if (LTE20_DDC_OUT_SAMPLES != 10) {
        printf("Error: Unexpected number of output samples. Expected 10, got %d\n", LTE20_DDC_OUT_SAMPLES);
        return -1;
    }
