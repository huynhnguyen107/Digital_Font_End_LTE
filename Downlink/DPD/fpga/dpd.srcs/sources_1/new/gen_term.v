...
module gen_term #(WIDTH=17)(
	...
	input [WIDTH-1:0] i_a,
	input [WIDTH-1:0] q_a,
	input [WIDTH-2:0] i_coe,
	input [WIDTH-2:0] q_coe,
	...
	term_cmpy_0 term_cmpy_0 (
	  ...
	  .s_axis_b_tdata({q_coe, i_coe}),          // input wire [31 : 0] s_axis_b_tdata
	  .m_axis_dout_tvalid(),  // output wire m_axis_dout_tvalid
	  .m_axis_dout_tdata(m_axis_dout_tdata)    // output wire [79 : 0] m_axis_dout_tdata
	);
	assign i_b = m_axis_dout_tdata[30:14];
	assign q_b = m_axis_dout_tdata[70:54];
endmodule
