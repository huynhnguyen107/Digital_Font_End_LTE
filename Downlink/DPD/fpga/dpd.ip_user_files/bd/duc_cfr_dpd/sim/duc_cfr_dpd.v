...
(* CORE_GENERATION_INFO = "duc_cfr_dpd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=duc_cfr_dpd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=14,numReposBlks=14,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "duc_cfr_dpd.hwdef" *) 
module duc_cfr_dpd
   ();
  ...
  wire [31:0]dpd_0_m_axis_TDATA;
  wire [3:0]dpd_0_m_axis_TKEEP;
  wire dpd_0_m_axis_TLAST;
  wire dpd_0_m_axis_TREADY;
  wire dpd_0_m_axis_TVALID;
  ...
  duc_cfr_dpd_ila_0_0 ila_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .probe7(1'b0),
        .probe8(1'b0));
  duc_cfr_dpd_ila_0_1 ila_1
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .probe0(dpd_0_m_axis_TREADY),
        .probe1(dpd_0_m_axis_TDATA),
        .probe2({1'b1,1'b1,1'b1,1'b1}),
        .probe3(dpd_0_m_axis_TVALID),
        .probe4(dpd_0_m_axis_TLAST),
        .probe5(1'b0),
        .probe6(dpd_0_m_axis_TKEEP),
        .probe7(1'b0),
        .probe8(1'b0));
