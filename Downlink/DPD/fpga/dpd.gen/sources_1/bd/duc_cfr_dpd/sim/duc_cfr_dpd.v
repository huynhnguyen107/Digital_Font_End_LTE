...
(* CORE_GENERATION_INFO = "duc_cfr_dpd,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=duc_cfr_dpd,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=15,numReposBlks=15,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=6,numPkgbdBlks=0,bdsource=USER,synth_mode=OOC_per_IP}" *) (* HW_HANDOFF = "duc_cfr_dpd.hwdef" *) 
module duc_cfr_dpd
   ();
  ...
  wire [31:0]axis_upsample_0_m_axis_TDATA;
  wire [3:0]axis_upsample_0_m_axis_TKEEP;
  wire axis_upsample_0_m_axis_TLAST;
  wire axis_upsample_0_m_axis_TREADY;
  wire axis_upsample_0_m_axis_TVALID;
  wire [31:0]axis_upsample_1_m_axis_TDATA;
  wire [3:0]axis_upsample_1_m_axis_TKEEP;
  wire axis_upsample_1_m_axis_TLAST;
  wire axis_upsample_1_m_axis_TREADY;
  wire axis_upsample_1_m_axis_TVALID;
  wire [31:0]cfr_0_m_axis_TDATA;
  wire [3:0]cfr_0_m_axis_TKEEP;
  ...
  (* CONN_BUS_INFO = "dpd_0_m_axis xilinx.com:interface:axis:1.0 None TREADY" *) (* DONT_TOUCH *) wire dpd_0_m_axis_TREADY;
  (* CONN_BUS_INFO = "dpd_0_m_axis xilinx.com:interface:axis:1.0 None TVALID" *) (* DONT_TOUCH *) wire dpd_0_m_axis_TVALID;
  wire [31:0]halfband_fir_0_m_axis_TDATA;
  wire [3:0]halfband_fir_0_m_axis_TKEEP;
  wire halfband_fir_0_m_axis_TLAST;
  wire halfband_fir_0_m_axis_TREADY;
  wire halfband_fir_0_m_axis_TVALID;
  wire [31:0]halfband_fir_1_m_axis_TDATA;
  wire [3:0]halfband_fir_1_m_axis_TKEEP;
  wire halfband_fir_1_m_axis_TLAST;
  wire halfband_fir_1_m_axis_TREADY;
  wire halfband_fir_1_m_axis_TVALID;
  ...
  duc_cfr_dpd_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  duc_cfr_dpd_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(dpd_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep(dpd_0_m_axis_TKEEP),
        .s_axis_s2mm_tlast(dpd_0_m_axis_TLAST),
        .s_axis_s2mm_tready(dpd_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(dpd_0_m_axis_TVALID));
  duc_cfr_dpd_axis_upsample_0_0 axis_upsample_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axis_tdata(axis_upsample_0_m_axis_TDATA),
        .m_axis_tkeep(axis_upsample_0_m_axis_TKEEP),
        .m_axis_tlast(axis_upsample_0_m_axis_TLAST),
        .m_axis_tready(axis_upsample_0_m_axis_TREADY),
        .m_axis_tvalid(axis_upsample_0_m_axis_TVALID),
        .s_axis_tdata(axi_dma_0_M_AXIS_MM2S_TDATA),
        .s_axis_tkeep(axi_dma_0_M_AXIS_MM2S_TKEEP),
        .s_axis_tlast(axi_dma_0_M_AXIS_MM2S_TLAST),
        .s_axis_tready(axi_dma_0_M_AXIS_MM2S_TREADY),
        .s_axis_tvalid(axi_dma_0_M_AXIS_MM2S_TVALID));
  duc_cfr_dpd_axis_upsample_1_0 axis_upsample_1
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axis_tdata(axis_upsample_1_m_axis_TDATA),
        .m_axis_tkeep(axis_upsample_1_m_axis_TKEEP),
        .m_axis_tlast(axis_upsample_1_m_axis_TLAST),
        .m_axis_tready(axis_upsample_1_m_axis_TREADY),
        .m_axis_tvalid(axis_upsample_1_m_axis_TVALID),
        .s_axis_tdata(halfband_fir_0_m_axis_TDATA),
        .s_axis_tkeep(halfband_fir_0_m_axis_TKEEP),
        .s_axis_tlast(halfband_fir_0_m_axis_TLAST),
        .s_axis_tready(halfband_fir_0_m_axis_TREADY),
        .s_axis_tvalid(halfband_fir_0_m_axis_TVALID));
  duc_cfr_dpd_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  duc_cfr_dpd_cfr_0_0 cfr_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axis_tdata(cfr_0_m_axis_TDATA),
        .m_axis_tkeep(cfr_0_m_axis_TKEEP),
        .m_axis_tlast(cfr_0_m_axis_TLAST),
        .m_axis_tready(cfr_0_m_axis_TREADY),
        .m_axis_tvalid(cfr_0_m_axis_TVALID),
        .s_axis_tdata(halfband_fir_1_m_axis_TDATA),
        .s_axis_tkeep(halfband_fir_1_m_axis_TKEEP),
        .s_axis_tlast(halfband_fir_1_m_axis_TLAST),
        .s_axis_tready(halfband_fir_1_m_axis_TREADY),
        .s_axis_tvalid(halfband_fir_1_m_axis_TVALID));
  duc_cfr_dpd_dpd_0_0 dpd_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .m_axis_tready(dpd_0_m_axis_TREADY),
        .m_axis_tvalid(dpd_0_m_axis_TVALID),
        .s_axis_tdata(cfr_0_m_axis_TDATA),
        .s_axis_tkeep(cfr_0_m_axis_TKEEP),
        .s_axis_tlast(cfr_0_m_axis_TLAST),
        .s_axis_tready(cfr_0_m_axis_TREADY),
        .s_axis_tvalid(cfr_0_m_axis_TVALID));
  duc_cfr_dpd_halfband_fir_0_0 halfband_fir_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axis_tdata(halfband_fir_0_m_axis_TDATA),
        .m_axis_tkeep(halfband_fir_0_m_axis_TKEEP),
        .m_axis_tlast(halfband_fir_0_m_axis_TLAST),
        .m_axis_tready(halfband_fir_0_m_axis_TREADY),
        .m_axis_tvalid(halfband_fir_0_m_axis_TVALID),
        .s_axis_tdata(axis_upsample_0_m_axis_TDATA),
        .s_axis_tkeep(axis_upsample_0_m_axis_TKEEP),
        .s_axis_tlast(axis_upsample_0_m_axis_TLAST),
        .s_axis_tready(axis_upsample_0_m_axis_TREADY),
        .s_axis_tvalid(axis_upsample_0_m_axis_TVALID));
  duc_cfr_dpd_halfband_fir_1_0 halfband_fir_1
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
        .m_axis_tdata(halfband_fir_1_m_axis_TDATA),
        .m_axis_tkeep(halfband_fir_1_m_axis_TKEEP),
        .m_axis_tlast(halfband_fir_1_m_axis_TLAST),
        .m_axis_tready(halfband_fir_1_m_axis_TREADY),
        .m_axis_tvalid(halfband_fir_1_m_axis_TVALID),
        .s_axis_tdata(axis_upsample_1_m_axis_TDATA),
        .s_axis_tkeep(axis_upsample_1_m_axis_TKEEP),
        .s_axis_tlast(axis_upsample_1_m_axis_TLAST),
        .s_axis_tready(axis_upsample_1_m_axis_TREADY),
        .s_axis_tvalid(axis_upsample_1_m_axis_TVALID));
  duc_cfr_dpd_ila_0_0 ila_0
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        .probe0(cfr_0_m_axis_TREADY),
        .probe1(cfr_0_m_axis_TDATA),
        .probe2({1'b1,1'b1,1'b1,1'b1}),
        .probe3(cfr_0_m_axis_TVALID),
        .probe4(cfr_0_m_axis_TLAST),
        .probe5(1'b0),
        .probe6(cfr_0_m_axis_TKEEP),
        .probe7(1'b0),
        .probe8(1'b0));
  duc_cfr_dpd_ila_0_2 ila_2
       (.clk(zynq_ultra_ps_e_0_pl_clk0),
        ...
        .probe7(1'b0),
        .probe8(1'b0));
  duc_cfr_dpd_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  duc_cfr_dpd_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  duc_cfr_dpd_system_ila_0_0 system_ila_0
       (.SLOT_0_AXIS_tdata(dpd_0_m_axis_TDATA),
        .SLOT_0_AXIS_tkeep(dpd_0_m_axis_TKEEP),
        .SLOT_0_AXIS_tlast(dpd_0_m_axis_TLAST),
