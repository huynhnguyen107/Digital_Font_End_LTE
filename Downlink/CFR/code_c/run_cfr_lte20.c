...
#include "lte20_duc_cfr_golden_q15.h"// for the golden output data slot
...
int main(void) {
    ...
    for (size_t i = 0; i < LTE20_DUC_CFR_OUT_SAMPLES; i++) {
    ...
    DMA_REG(dma, DMA_S2MM_LENGTH_OFFSET) = LTE20_DUC_CFR_OUT_BYTES; // Set S2MM transfer length
    ...
    for (size_t i = 0; i < LTE20_DUC_CFR_OUT_SAMPLES; i++) {
        ...
        uint32_t golden_sample = lte20_duc_cfr_golden_q15[i];
