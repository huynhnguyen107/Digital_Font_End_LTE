...
module cfr #(parameter WIDTH=32, THRESHOLD=16'd19660)(
	...
	localparam DELAY_DIVIDER=DELAY_CORDIC+34;
	...
	div_gen_0 div_gen_0 (
	  ...
	  .m_axis_dout_tdata(gain_32)            // output wire [31 : 0] m_axis_dout_tdata
	);
	assign gain = gain_32[16:1];
	//scale
	i_scale i_scale_1 (
	  .CLK(aclk),  // input wire CLK
