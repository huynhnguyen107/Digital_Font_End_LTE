...
//Date        : Thu Jun  4 08:40:10 2026
//Host        : LAPTOP-CHCSI1R5 running 64-bit major release  (build 9200)
//Command     : generate_target duc_cfr.bd
//Design      : duc_cfr
//Purpose     : IP block netlist
//--------------------------------------------------------------------------------
`timescale 1 ps / 1 ps

(* CORE_GENERATION_INFO = "duc_cfr,IP_Integrator,{x_ipVendor=xilinx.com,x_ipLibrary=BlockDiagram,x_ipName=duc_cfr,x_ipVersion=1.00.a,x_ipLanguage=VERILOG,numBlks=11,numReposBlks=11,numNonXlnxBlks=0,numHierBlks=0,maxHierDepth=0,numSysgenBlks=0,numHlsBlks=0,numHdlrefBlks=5,numPkgbdBlks=0,bdsource=USER,synth_mode=Global}" *) (* HW_HANDOFF = "duc_cfr.hwdef" *) 
module duc_cfr
   ();
  ...
  duc_cfr_axi_bram_ctrl_0_0 axi_bram_ctrl_0
  ...
  duc_cfr_axi_dma_0_0 axi_dma_0
       (.axi_resetn(proc_sys_reset_0_peripheral_aresetn),
        ...
        .s_axis_s2mm_tdata(cfr_0_m_axis_TDATA),
        .s_axis_s2mm_tkeep(cfr_0_m_axis_TKEEP),
        .s_axis_s2mm_tlast(cfr_0_m_axis_TLAST),
        .s_axis_s2mm_tready(cfr_0_m_axis_TREADY),
        .s_axis_s2mm_tvalid(cfr_0_m_axis_TVALID));
  duc_cfr_axis_upsample_0_0 axis_upsample_0
  ...
  duc_cfr_axis_upsample_0_1 axis_upsample_1
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
  ...
  duc_cfr_blk_mem_gen_0_0 blk_mem_gen_0
  ...
  duc_cfr_halfband_fir_0_0 halfband_fir_0
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
  ...
  duc_cfr_halfband_fir_0_1 halfband_fir_1
       (.aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn),
  ...
  duc_cfr_proc_sys_reset_0_0 proc_sys_reset_0
       (.aux_reset_in(1'b1),
        .dcm_locked(1'b1),
  ...
  duc_cfr_smartconnect_0_0 smartconnect_0
       (.M00_AXI_araddr(smartconnect_0_M00_AXI_ARADDR),
        ...
        .aclk(zynq_ultra_ps_e_0_pl_clk0),
        .aresetn(proc_sys_reset_0_peripheral_aresetn));
  duc_cfr_zynq_ultra_ps_e_0_0 zynq_ultra_ps_e_0
